...
void affichage_podium(score_t * info_score){
    ...
    mvprintw((rows/2)+3, (cols/6)-10, "%s", info_score->last_survivors[1]); 
    mvprintw((rows/2)+1, (cols/6), "%s", info_score->last_survivors[0]); 
    mvprintw((rows/2)+4, (cols/6)+10, "%s", info_score->last_survivors[2]); 

    mvprintw((rows/2)+3, (4*cols/6)-10, "%s", info_score->deuxieme.login_joueur.pseudo); 
    mvprintw((rows/2)+1, (4*cols/6), "%s", info_score->premier.login_joueur.pseudo); 
    mvprintw((rows/2)+4, (4*cols/6)+10, "%s", info_score->troisieme.login_joueur.pseudo); 

    mvprintw((rows/2)+2, (4*cols/6)-10, "(%d)", info_score->deuxieme.score); 
    mvprintw((rows/2), (4*cols/6), "(%d)", info_score->premier.score); 
    mvprintw((rows/2)+3, (4*cols/6)+10, "(%d)", info_score->troisieme.score); 
